...
import { Calendar, User, Clock, CheckCircle, PlusCircle, Sparkles } from 'lucide-react'

const upcomingAppointments = [
  { id: 1, service: 'Full Platinum Slay & Silk Press', stylist: 'House of Roxxy', date: 'Oct 24, 2026', time: '2:00 PM', status: 'Confirmed' },
  { id: 2, service: 'Structural Trim & Blowout', stylist: 'Matteo', date: 'Nov 12, 2026', time: '11:30 AM', status: 'Pending Approval' },
]
      ...
      <section className='mx-auto w-full max-w-6xl flex-1 px-6 py-12 md:px-10 relative z-10 space-y-12'>
        ...
        <div className='flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-zinc-800/60 pb-8'>
          ...
          <div>
            <p className='text-xs font-black uppercase tracking-[0.2em] text-fuchsia-400 mb-1 flex items-center gap-1.5'>
              <Sparkles className="w-3 h-3 animate-pulse" /> Welcome Back, Queen
            </p>
            <h1 className='text-3xl font-black tracking-tight bg-gradient-to-r from-white via-zinc-200 to-zinc-400 bg-clip-text text-transparent md:text-4xl'>
          ...
          <Button
            asChild
            size='lg'
            className='bg-gradient-to-r from-fuchsia-500 to-violet-600 hover:from-fuchsia-600 hover:to-violet-700 text-white font-bold tracking-wide rounded-full shadow-lg shadow-fuchsia-500/10 transition-all hover:scale-105'
          >
        ...
        <div className='grid gap-8 lg:grid-cols-3 items-start'>
              ...
              {upcomingAppointments.map((apt) => (
                ...
                >
                  <div className='space-y-1.5'>
                    ...
                    <p className='text-sm text-zinc-400'>with <span className='text-zinc-200 font-medium'>{apt.stylist}</span></p>
          ...
          <div className='space-y-6'>
            ...
            <div className='p-6 rounded-2xl bg-gradient-to-b from-zinc-900/60 to-zinc-900/20 border border-zinc-800/80 backdrop-blur-md space-y-6'>
              <div className='space-y-4'>
